...
c.colors.tabs.even.fg = '#e0def4'
c.colors.tabs.odd.fg = '#e0def4'
c.colors.tabs.selected.even.bg = '#26233a'
c.colors.tabs.selected.odd.bg = '#26233a'
c.colors.tabs.selected.even.fg = '#ebbcba'
c.colors.tabs.selected.odd.fg = '#ebbcba'
c.colors.tabs.indicator.start = '#9ccfd8'
c.colors.tabs.indicator.stop = '#31748f'
